                            ...
                            <div class="col-12">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    @if($application_status != "APPROVE")
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <form class="petition" method="POST" action="{{ url('request/out-of-time-without-penalty', $uuid)}}" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-xl-12 mb-30">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12 col-md-12 col-xl-12" style="margin-top:0px;">
                                                                    <h4><input style="border: 0px;size: auto;" type="text" name="names[]"  multiple value="Notice to Renew" readonly></h4>
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-9">

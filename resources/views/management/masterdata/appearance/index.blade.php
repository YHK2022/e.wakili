                    ...
                    <div class="col-lg-4">
                        <nav class="breadcrumb-container" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Attachmant Type</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="modal fade" id="addSession" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <form class="forms-sample" method="POST" action="{{ url('settings/appearance/add') }}">
                                {{ csrf_field() }}
                                <div class="modal-header">
                                    <h5 class="modal-title" id="demoModalLabel">Add appearance</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">appearance Name</label>
                                ...
                                <tbody>
                                    @foreach ($appearances as $key => $appearance)
                                        <tr>
                                            ...
                                            <td id="table_id">{{ $appearance->name }}</td>
                                            <td id="table_id">{{ $appearance->description }}</td>
                                            <td id="table_id">
                                                <div class="table-actions">

                                                    <a href="#edit{{ $appearance->id }}" title="Edit"
                                                        data-toggle="modal" data-id="{{ $appearance->id }}"
                                                        data-target="#edit{{ $appearance->id }}"><i
                                                            class="ik ik-edit-2"></i></a>
                                                    <a href="#delete{{ $appearance->id }}" title="Delete"
                                                        data-toggle="modal" data-id="{{ $appearance->id }}"
                                                        data-target="#delete{{ $appearance->id }}"><i
                                        ...
                                        <!-- Edit Session Model-->
                                        <div class="modal fade" id="edit{{ $appearance->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <form class="forms-sample" method="POST"
                                                        action="{{ url('settings/appearance/edit', $appearance->id) }}">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="demoModalLabel">appearance</h5>
                                        ...
                                        <div class="modal fade" id="delete{{ $appearance->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    <form class="forms-sample" method="POST"
                                                        action="{{ url('settings/appearance/delete', $appearance->id) }}">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">

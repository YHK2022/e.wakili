                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a title="Edit" href="{{ url('user-management/role/edit', $role->id) }}"><i class="ik ik-edit-2"></i>
                                            </a>
                                            <a title="Delete" href="{{ url('user-management/role/delete', $role->id) }}"><i class="ik ik-trash-2"></i>
                                            </a>
                                        </div>
                                    </td>
                                </tr>

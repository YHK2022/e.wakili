            ...
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div @if (\Request::is('sessions/petition-session') || \Request::is('sessions/pending-admission')) class="nav-item has-sub active open" @endif
                    ...
                    <div class="submenu-content">
                        <a @if (\Request::is('sessions/petition-session')) class="menu-item active" @endif
                            href="{{ url('sessions/petition-session') }}" class="menu-item">Petition Sessions </a>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Resume
                            Petition</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('petition-resume/rhc-inspection')) class="menu-item active" @endif
                            href="{{ url('petition-resume/rhc-inspection') }}" class="menu-item">RHC Inspection </a>
                        <a @if (\Request::is('petition-resume/cle-approval')) class="menu-item active" @endif
                            href="{{ url('petition-resume/cle-approval') }}" class="menu-item">CLE Approval </a>
                        <a @if (\Request::is('petition-resume/cj-approval')) class="menu-item active" @endif
                            href="{{ url('petition-resume/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Late
                            Renewals</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('out-of-time/under-review')) class="menu-item active" @endif
                            href="{{ url('out-of-time/under-review') }}" class="menu-item">Under Reveiw </a>
                        <a @if (\Request::is('out-of-time/rhc-review')) class="menu-item active" @endif
                            href="{{ url('out-of-time/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('out-of-time/cj-approval')) class="menu-item active" @endif
                            href="{{ url('out-of-time/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (\Request::is('resume/under-review') || \Request::is('resume/rhc-review') || \Request::is('resume/cj-approval')) class="nav-item has-sub active open" @endif
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Resume
                            Practising</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('resume/under-review')) class="menu-item active" @endif
                            href="{{ url('resume/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('resume/rhc-review')) class="menu-item active" @endif
                            href="{{ url('resume/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('resume/cj-approval')) class="menu-item active" @endif
                            href="{{ url('resume/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (\Request::is('suspend/under-review') || \Request::is('suspend/rhc-review') || \Request::is('suspend/cj-approval')) class="nav-item has-sub active open" @endif
                    ...
                    <div class="submenu-content">
                        <a @if (\Request::is('suspend/under-review')) class="menu-item active" @endif
                            href="{{ url('suspend/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('suspend/rhc-review')) class="menu-item active" @endif
                            href="{{ url('suspend/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('suspend/cj-approval')) class="menu-item active" @endif
                            href="{{ url('suspend/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>None
                            Practising</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('non-practising/under-review')) class="menu-item active" @endif
                            href="{{ url('non-practising/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('non-practising/rhc-review')) class="menu-item active" @endif
                            href="{{ url('non-practising/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('non-practising/cj-approval')) class="menu-item active" @endif
                            href="{{ url('non-practising/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>

                <div @if (\Request::is('retire/under-review') || \Request::is('retire/under-review') || \Request::is('retire/cj-approval')) class="nav-item has-sub active open" @endif
                    class="nav-item has-sub">
                    <a class="dropdown" href="javascript:void(0)"><i
                            class="ik ik-file-text"></i><span>Retiring</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('retire/under-review')) class="menu-item active" @endif
                            href="{{ url('retire/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('retire/under-review')) class="menu-item active" @endif
                            href="{{ url('retire/under-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('retire/cj-approval')) class="menu-item active" @endif
                            href="{{ url('retire/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Not for
                            Profit</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('not-profit/under-review')) class="menu-item active" @endif
                            href="{{ url('not-profit/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('not-profit/rhc-review')) class="menu-item active" @endif
                            href="{{ url('not-profit/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('not-profit/cj-approval')) class="menu-item active" @endif
                            href="{{ url('not-profit/cj-approval') }}" class="menu-item">CJ Approval </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Name
                            Change</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('name-change/under-review')) class="menu-item active" @endif
                            href="{{ url('name-change/under-review') }}" class="menu-item">Under Review </a>
                        <a @if (\Request::is('name-change/rhc-review')) class="menu-item active" @endif
                            href="{{ url('name-change/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('name-change/jk-approval')) class="menu-item active" @endif
                            href="{{ url('name-change/kj-approval') }}" class="menu-item">JK Approval </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <div class="submenu-content">
                        <a @if (\Request::is('temp-admission/new-application')) class="menu-item active" @endif
                            href="{{ url('temp-admission/new-application') }}" class="menu-item">New Applications
                        </a>
                        <a @if (\Request::is('temp-admission/rhc-review')) class="menu-item active" @endif
                            href="{{ url('temp-admission/rhc-review') }}" class="menu-item">RHC Review </a>
                        <a @if (\Request::is('temp-admission/cj-approval')) class="menu-item active" @endif
                            href="{{ url('temp-admission/cj-approval') }}" class="menu-item">CJ Approval </a>
                        <a @if (\Request::is('temp-admission/temp-advocates')) class="menu-item active" @endif
                            href="{{ url('temp-admission/temp-advocates') }}" class="menu-item">Temporary Advocates
                        </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-file-text"></i><span>Application
                            Tracking</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('trace-application/petition')) class="menu-item active" @endif
                            href="{{ url('trace-application/petition') }}" class="menu-item">Petition Applications
                        </a>
                        <a @if (\Request::is('trace-application/permit')) class="menu-item active" @endif
                            href="{{ url('trace-application/permit') }}" class="menu-item">Permit Requests </a>
                        <a @if (\Request::is('trace-application/temp-admission')) class="menu-item active" @endif
                            href="{{ url('trace-application/temp-admission') }}" class="menu-item">TempAdmissions
                        </a>
                        <a @if (\Request::is('trace-application/resume-petition')) class="menu-item active" @endif
                            href="{{ url('trace-application/resume-petition') }}" class="menu-item">Resume Petition
                        </a>
                    </div>
                </div>
                ...
                <div @if (
                    ...
                    <a class="dropdown" href="javascript:void(0)"><i class="ik ik-clipboard"></i><span>Payments &
                            Bills</span></a>
                    <div class="submenu-content">
                        <a @if (\Request::is('bills/pending')) class="menu-item active" @endif
                            href="{{ url('bills/pending') }}" class="menu-item">Pending </a>
                        <a @if (\Request::is('bills/paid')) class="menu-item active" @endif
                            href="{{ url('bills/paid') }}" class="menu-item">Paid </a>
                        <a @if (\Request::is('bills/cancelled')) class="menu-item active" @endif
                            href="{{ url('bills/cancelled') }}" class="menu-item">Cancelled </a>
                        <a @if (\Request::is('bills/expired')) class="menu-item active" @endif
                            href="{{ url('bills/expired') }}" class="menu-item">Expired </a>
                        <a @if (\Request::is('bills/reconciliation')) class="menu-item active" @endif
                            href="{{ url('bills/reconciliation') }}" class="menu-item">Cancelled </a>
                    </div>
                </div>

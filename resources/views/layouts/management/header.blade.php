                    ...
                    <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                        ...
                        <div class="notifications-wrap">
                            ...
                            <a href="#" class="media">
                                <span class="d-flex">
                                    {{-- @if ($profile)
                                                <img src="{{ asset('storage/files/'.$profile->picture) }}" class="rounded-circle" alt="">
                                            @else
                                                <img src="{{ URL::to('/images/user.png') }}" class="rounded-circle" alt="">
                                            @endif --}}
                                </span>
                                <span class="media-body">
                ...
                <div class="dropdown">
                    <a class="dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        @if (!empty($profile->picture))
                            <img class="avatar" src="{{ asset('storage/files/' . $profile->picture) }}"
                                alt="">
                    </a>
                @else
                    <img class="avatar" src="{{ URL::to('images/user.png') }}" alt=""></a>
                    @endif
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ url('user-management/profile') }}"><i
                        ...
                        <a class="dropdown-item" href="#"><i class="ik ik-navigation dropdown-icon"></i>
                            Message</a>
                        <a class="dropdown-item" href="{{ url('logout') }}"><i class="ik ik-power dropdown-icon"></i>
                            Logout</a>
                    </div>
                </div>
